...
public sealed class ProtocolTests
{
    ...
    public async Task CdpCancellationAndSocketLossReleasePendingRequests(string scenario)
    {
        ...
        if (scenario == "hold")
            ...
            Assert.That(Assert.ThrowsAsync<UcException>(async () => await connection.SendAsync("Browser.getVersion", null, null, deadline.Token))!.Category, Is.EqualTo(ErrorCategory.DevToolsEndpointFailure));
    }
